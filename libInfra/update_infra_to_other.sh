...
#需要更新include的头文件
do_file_include[0]="IEventMeta.h"
do_file_include[1]="FileMonitor.h"
do_file_include[2]="infra/Handler.h"
do_file_include[3]="infra/ICallBack.h"
do_file_include[4]="infra/IEventManager.h"
do_file_include[5]="infra/InfraBase.h"
do_file_include[6]="infra/Looper.h"
do_file_include[7]="infra/Message.h"
do_file_include[8]="infra/MessageQueue.h"
do_file_include[9]="infra/Mutex.h"
do_file_include[10]="infra/smartPointer.h"
do_file_include[11]="infra/Thread.h"
do_file_include[12]="infra/Timer.h"
do_file_include[13]="infra/TimerPool.h"

#需要更新的src源码文件
do_file_src[0]="FileMonitor.cpp"
do_file_src[1]="Handler.cpp"
do_file_src[2]="IEventManager.cpp"
do_file_src[3]="InfraBase.cpp"
do_file_src[4]="Looper.cpp"
do_file_src[5]="Message.cpp"
do_file_src[6]="MessageQueue.cpp"
do_file_src[7]="Mutex.cpp"
do_file_src[8]="smartPointer.cpp"
do_file_src[9]="Thread.cpp"
do_file_src[10]="Timer.cpp"
do_file_src[11]="TimerPool.cpp"

#需要更新的其他文件(相对当前目录)
do_file_other[0]="infra_README.md"
