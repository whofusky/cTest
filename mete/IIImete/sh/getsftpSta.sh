...
#dsc          :
#    get the status of the sftp server
#
#invoke eg    :
#   ./getsftpSta.sh 0 0 192.168.0.51 fczx fczx "/home/fczx/fushikai_test/sftp_dir/tdir1" "/home/fczx/tmp" "busilist_20200929_0.xml"
#
#version chg  :
#   20201120@created
#
...
writeLog 4 "\n${logTime} sftpRet=[${sftpRet}]"
writeLog 1 "${logTime} The sftp server[${sftpIP} ${sftpCtrPNum}] is in a normal state.The file[${fileName}] exists in the [${sftpRdir}] path of the server!\n"
