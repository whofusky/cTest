...
////////MODBUS 功能码定义///////////////////////////////////
#define  MC_MBFC_0x00      0x00 //自定义扩展功能码0:新联一个通道
...
//判断功能码是否在定义的范围内
#define ASSERTMBFC(mbFc) ( (mbFc) == MC_MBFC_0x00 \
                           || (mbFc) == MC_MBFC_0x01 \
                           || (mbFc) == MC_MBFC_0x02 \
                           || (mbFc) == MC_MBFC_0x03 \
                           || (mbFc) == MC_MBFC_0x04 \
...
#define PNTTYPE_NULL_SET   0    //信息对象没有信息元素集
...
#define U_NEWHOLD       18      //用U帧的STARTDT STOPDT TESTFR 全为0 表示出新的
//会话：新联一个通道
#define U_DELHOLD       19      //用U帧的STARTDT STOPDT TESTFR 全为1 表示出新的
//会话：关一个通道
