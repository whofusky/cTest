...
#需要更新include的头文件
do_file_include[0]="PvCfg.h"
do_file_include[1]="minIni.h"
do_file_include[2]="minGlue.h"
do_file_include[3]="FileReceiver.h"

#需要更新的src源码文件
do_file_src[0]="PvCfg.cpp"
do_file_src[1]="minIni.c"
do_file_src[2]="FileReceiver.cpp"

#需要更新的其他文件(相对当前目录)
do_file_other[0]="PvCfg_README.md"
do_file_other[1]="公共及私有配置文件取值接口说明.pdf"
