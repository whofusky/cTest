...
#需要更新include的头文件
do_file_include[0]="libbase64.h"
do_file_include[1]="FileToBase64.h"

#需要更新的src源码文件
do_file_src[0]="libbase64.c"
do_file_src[1]="FileToBase64.cpp"

#需要更新的其他文件(相对当前目录)
do_file_other[0]="base64_README.md"
do_file_other[1]="base64_README.pdf"
